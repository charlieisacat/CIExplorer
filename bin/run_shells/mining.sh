...
do
    ...
    ./split_bb ../bitcode/${BENCH}_run_rn.bc ../data/bblist.txt $graphdata_step_file/graphdata_bb ../data/weights.txt $config_file $Nin $Nout $pack_n
    ...
    echo "GA..."
    echo $"${MINING_ROOT}/bin/run_shells/search.sh ../bitcode/${BENCH}_run_rn.bc $graphdata_step_file/graphdata_bb  $gspan_output_step_file $Nin $Nout $NOCONST $config_file"
    ${MINING_ROOT}/bin/run_shells/search.sh ../bitcode/${BENCH}_run_rn.bc $graphdata_step_file/graphdata_bb  $gspan_output_step_file $Nin $Nout $NOCONST $config_file $pack_n
...
# ./visualize ../bitcode/${BENCH}_run_rn.bc to_debug_pass ../data/weights.txt
